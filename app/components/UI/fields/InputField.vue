<template>
  <div class="relative rounded-md shadow-sm">
    ...
    <input :type="type" :id="id" :name="id" :value="modelValue"
           class="block w-full rounded-md border-0 py-1.5 pl-3 sm:text-sm sm:leading-6 focus:outline-none focus:ring-azure"
           :class="{ 'text-red-900 ring-1 ring-inset ring-red-300 placeholder:text-red-300 focus:ring-2 focus:ring-inset focus:ring-red-500': error, 'text-grey ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset ': !error }"
           @input="updateValue"
           :placeholder="label"
           :required="required"    />
  </div>
